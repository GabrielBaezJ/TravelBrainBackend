...
Backend API para TravelBrain - Generador de itinerarios de viaje personalizados con integración de clima, presupuesto y distancias.
...
- MongoDB instalado localmente O una cuenta de MongoDB Atlas
- npm o yarn
